...
КРИТИЧЕСКИ ВАЖНО ПРО ЯЗЫК: отвечай ВСЕГДА и ТОЛЬКО на русском языке, при любых обстоятельствах, даже если вопрос на другом языке или непонятен. НИКОГДА не используй китайский, английский или любые другие языки. Если сомневаешься или не понял ввод — переспроси на русском. Будь дружелюбным!";
    }
}
